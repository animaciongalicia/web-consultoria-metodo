...
export const metadata: Metadata = {
  ...
  description:
    "Guía práctica para organizar tu empresa: procesos, delegación, sistemas simples y cómo liberar tiempo. Consultor de negocios en Coruña, Galicia y por videollamada en el resto de España.",
  keywords: [
