...
export const STATIC_PAGES = [
  ...
  { path: "/sobre-consultoria-metodo", priority: 0.85, changeFrequency: "monthly" as const },
  { path: "/pablo-garcia-dacosta", priority: 0.85, changeFrequency: "monthly" as const },
  { path: "/rentabilismo", priority: 0.85, changeFrequency: "monthly" as const },
  { path: "/libros", priority: 0.8, changeFrequency: "monthly" as const },
  { path: "/preguntas-frecuentes", priority: 0.7, changeFrequency: "monthly" as const },
  { path: "/redes-sociales", priority: 0.6, changeFrequency: "monthly" as const },
